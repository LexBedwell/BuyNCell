...
const {pingServices} = require('./utils/services/serviceCheck')
...
try {
  ...
  console.warn('Unable to load local env file. This file is not used in production, but is needed to run app locally.')
}
